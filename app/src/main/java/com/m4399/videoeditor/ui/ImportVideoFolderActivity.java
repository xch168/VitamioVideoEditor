...
import com.m4399.videoeditor.entity.VideoThumb;
import com.m4399.videoeditor.adapter.ImportVideoFolderAdapter;
...
public class ImportVideoFolderActivity extends BaseActivity implements OnClickListener, OnItemClickListener
{
    ...
    private static final String[] VIDEO_PROJECT = {MediaStore.Video.Media._ID, MediaStore.Video.Media.DATE_MODIFIED, MediaStore.Video.Media.DURATION,
    ...
    {
        mListView = findViewById(R.id.folder_list);
    ...
    protected List<VideoFolder> loadData() throws Exception
    {
        ...
        Cursor cursor = getContentResolver().query(MediaStore.Video.Media.EXTERNAL_CONTENT_URI, VIDEO_PROJECT, null, null,
