...
import com.m4399.videoeditor.adapter.ImportVideoSelectionAdapter;
...
public class ImportVideoSelectActivity extends BaseActivity implements OnItemClickListener, OnClickListener
{
    ...
    private void initView()
    {
        ...
        mNothing = findViewById(R.id.nodata);
        titleLeft = findViewById(R.id.titleLeft);
        titleLeft.setOnClickListener(this);
        titleText = findViewById(R.id.titleText);
        titleText.setText(mFolderName);
        titleRight = findViewById(R.id.titleRight);
        titleRightText = findViewById(R.id.titleRightTextView);
        videoListView = findViewById(R.id.folder_list);
    ...
    private ArrayList<VideoRow> loadData()
    {
        ...
        // DATE_MODIFIED是以秒为单位
        Cursor cursor = mContentResolver.query(MediaStore.Video.Media.EXTERNAL_CONTENT_URI, VIDEO_PROJECT, selection, null,
                                               MediaColumns.DATE_MODIFIED + " DESC");
        HashMap<String, ArrayList<Video>> mDataResult = new HashMap<>();
        ArrayList<Video> images = new ArrayList<>();
        ...
        ArrayList<VideoRow> result = new ArrayList<>();
        VideoRow row = null;
